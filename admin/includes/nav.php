...
if ($is_produits || $is_categories || $is_slider || $is_parametres || $is_commandes || $is_users) {
    $base_path = '../';
} else {
    $base_path = '';
}
...
<div class="admin-container">
    ...
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="<?php echo $base_path; ?>parametres.php" class="menu-item <?php echo (strpos($current_dir, '/parametres') !== false) ? 'active' : ''; ?>">
