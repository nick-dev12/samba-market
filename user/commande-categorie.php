...
<head>
    ...
    <title>Mes Commandes par Catégorie - Samba Market</title>
...
<body>
    ...
    <div class="content-header">
        ...
        <a href="mes-commandes.php" style="color: #918a44; text-decoration: none; font-size: 14px; margin-top: 10px; display: inline-block;">
    ...
    <section class="content-section">
        ...
        <div class="filter-section">
            <h3 style="font-size: 18px; color: #6b2f20; margin-bottom: 15px;">
        ...
        <?php if (empty($commandes_by_categorie)): ?>
            <div class="empty-state">
                ...
                <a href="mes-commandes.php" style="display: inline-block; margin-top: 20px; padding: 12px 25px; background: #918a44; color: #ffffff; text-decoration: none; border-radius: 8px;">
                            ...
                            <div class="produit-card-commande">
                                ...
                                <div class="produit-card-details">
                                    ...
                                    <div>
                                        ...
                                        <div class="detail-value" style="color: #c26638;">
                                ...
                                if ($date_commande): 
                                ?>
                                <div style="margin-top: 10px; padding-top: 10px; border-top: 1px solid #f0e9e9; font-size: 11px; color: #737373;">
