...
<head>
    ...
    <title><?php echo htmlspecialchars($produit['nom']); ?> - Trésor Africain</title>
    ...
    <div class="produit-detail-container">
        ...
        <div class="produit-detail-wrapper">
            ...
            <div class="produit-info-section">
                ...
                <span class="produit-categorie"><?php echo htmlspecialchars($produit['categorie_nom']); ?></span>
                ...
                <div class="produit-stock-info">
                    <div class="stock-item">
                        ...
                        <?php if (!empty($produit['unite']) && $produit['unite'] != 'unité'): ?>
                ...
                <?php else: ?>
                    <div style="padding: 20px; background-color: #f0e9e9; border-radius: 8px; text-align: center;">
                        <p style="margin-bottom: 15px; color: #484848;">Vous devez être connecté pour ajouter des produits
                            au panier.</p>
